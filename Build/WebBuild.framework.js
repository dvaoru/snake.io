...
var ASM_CONSTS = {
  5814404: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 5814459: ($0) => { performance.now = function() { return $0; }; },  
 5814507: ($0) => { performance.now = function() { return $0; }; },  
 5814555: () => { performance.now = Module['emscripten_get_now_backup']; }
};
